    ...
    "paths": {
        ...
        "/images": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created | Example {\\\"message\\\": \\\"...\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "400": {
                        "description": "Bad Request | Example {\\\"error\\\": \\\"...\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "415": {
                        "description": "Unsupported Media Type | Example {\\\"error\\\": \\\"only jpeg and png images are allowed\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/images/{imageID}": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK | Example {\\\"message\\\": \\\"image deleted\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/movies/like": {
            "put": {
                ...
                "responses": {
                    "201": {
                        "description": "OK | Example {\"message\": \"successfully liked movie\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/movies/unlike": {
            "put": {
                ...
                "responses": {
                    "201": {
                        "description": "OK | Example {\"message\": \"successfully unliked movie\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.deleteUserInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK | Example {\\\"message\\\": \\\"user successfully deleted\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "403": {
                        "description": "Forbidden | Example {\\\"error\\\": \\\"this resourse doesn't belong to authenticated user\\\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
